<x-layout>
    <div class="w-full md:w-3/4 mx-auto p-6 bg-gray-900 rounded-lg shadow mt-3">
        {{-- Question Header & Content sections remain unchanged --}}
        {{-- ... Previous question header and content code ... --}}
        ...
        <div class="mt-8 border-t border-gray-700 pt-6">
            ...
            {{-- Add Answer Form --}}
            @auth
            <form action="/question/{{ $question->id }}/answer" method="POST" class="mt-6">
                @csrf
            ...
            <p class="mt-6 text-gray-400">
                Please <a href="{{ route('login') }}" class="text-teal-500 hover:underline">login</a> to add an answer.
            </p>
            @endauth
        </div>
    </div>
